                        ...
                        <div className="grid grid-cols-1 items-start gap-6">
                            <div className="space-y-5">
                                <section className="space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/[0.06]">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs text-slate-500 dark:text-slate-400">Core details used to identify and classify the company.</p>
                                    </div>
                                ...
                                <FormInputField
                                    ...
                                    label="Code"
                                        ...
                                        <FormInputField
                                            ...
                                            label="Mailing Name"
                                        />
                                        <CompanyTypeDropdown form={form} gapClass={labelLayoutClass} />
                                ...
                                <section className="space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/[0.06]">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs text-slate-500 dark:text-slate-400">Primary communication details for business operations.</p>
                                    </div>
                                    <div className="space-y-4">
                                        <FormInputField
                                            type="text"
                                ...
                                <section className="space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/[0.06]">
                                    <div className="space-y-1">
                                        <h3 className="text-sm font-semibold text-slate-800 dark:text-slate-200">Tax and Compliance</h3>
                                        <p className="text-xs text-slate-500 dark:text-slate-400">Regulatory identifiers used in invoices and statutory reporting.</p>
                                    </div>
                                    <div className="space-y-4">
                                <FormInputField
                                    type="text"
                            ...
                            <section className="space-y-4 rounded-md border border-slate-200/70 bg-white p-3 sm:p-4 dark:border-white/[0.07] dark:bg-white/[0.06]">
                                <div className="space-y-1">
                                    ...
                                    <p className="text-xs text-slate-500 dark:text-slate-400">Registered location and jurisdiction details for the company.</p>
                                </div>
