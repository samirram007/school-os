...
// import { fetchStateService } from '@/features/base-modules/state/data/api'
// import type { State } from '@/features/base-modules/state/data/schema'
...
import type { State } from '@/features/base-modules/state/data/schema'
import { stateQueryOptions } from '@/features/base-modules/state/data/queryOptions'
