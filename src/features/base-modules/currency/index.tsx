...
import { currencyListSchema  } from './data/schema'
import type {CurrencyList} from './data/schema';
...
<h2 className='text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100'>Currency List</h2>
