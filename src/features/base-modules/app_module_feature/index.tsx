...
interface AppModuleFeatureProps {
    data: AppModuleFeatureList
}

export default function AppModuleFeature({ data }: AppModuleFeatureProps) {


    return (
        <AppModuleFeatureProvider>
...
<h2 className='text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100'>Application Module Features</h2>
                        <p className='text-slate-600 dark:text-slate-400'>
                            Manage your application module features.
                        </p>
                    </div>
                    <PrimaryButtons />
                </div>
                <div className='-mx-4 flex-1 overflow-auto px-4 py-1 lg:flex-row lg:space-y-0 lg:space-x-12'>
                    <GridTable
                        data={appModuleFeatureListSchema.parse(data ?? [])}
                        columns={columns} />
                </div>
            </Main>
